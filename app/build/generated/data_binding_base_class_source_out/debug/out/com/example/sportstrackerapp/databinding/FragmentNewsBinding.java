...
public final class FragmentNewsBinding implements ViewBinding {
  ...
  private FragmentNewsBinding(@NonNull LinearLayout rootView, @NonNull TabLayout tabLayout,
  ...
  public static FragmentNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentNewsBinding((LinearLayout) rootView, tabLayout, viewPager);
    }
